...
class StatsOverview extends BaseWidget
{
    ...
    {   
        return [
            ...
            ->description(empresa::query()->count() < 1 ? 'Nimodo' : 'Incremento')
        ...
        Stat::make('Tecnicos', emptecnico::query()->count())
            ->description(emptecnico::query()->count() < 1 ? 'Nimodo' : 'Incremento')
        ...
        Stat::make('Ordenes', ordenes::query()->count())
            ->description(ordenes::query()->count() < 1 ? 'Nimodo' : 'Incremento')
        ...
        Stat::make('Revisiones', revisiones::query()->count())
            ->description(revisiones::query()->count() < 1 ? 'Nimodo' : 'Incremento')
